...
# custom crop 
CUSTOM_CROP = True
BRUH = 300 # skip BRUH front / back pages 
...
def custom_crop(i):
    return i[y_up:-y_down:,x_left:-x_right]
...
for i in imgs: 
    all_slices += general_split(custom_crop(i) if CUSTOM_CROP else general_crop(i)) 
