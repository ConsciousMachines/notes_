...
enum TermType {Var, Lam, App, Ann, Hole, And_intro, And_elim0, And_elim1}
...
class Term {
    ...
    static Term and_intro(Term t1, Term t2) {
        return new Term(TermType.And_intro, t1, t2, null, null, null);
    }

    static Term and_elim0(Term t) {
        return new Term(TermType.And_elim0, t, null, null, null, null);
    }

    static Term and_elim1(Term t) {
        return new Term(TermType.And_elim1, t, null, null, null, null);
    }
}

enum TypeKind {Var, Arrow, And}
...
class proust_2 {
    ...
    Type type_synth(ContextNode ctx, Term expr) {
        ...
        switch (expr.t) // Var, Lam, App, Ann, Hole
        {
            ...
            case Var:
                ...
                if (t == null) throw new RuntimeException("term not in context: " + expr);
                return t;
            default:
    ...
    void test() {
        ...
        Term soy1 = Term.app(Term.and_elim0(Term.var("a")), Term.and_elim0(Term.var("b")));
        Term soy2 = Term.app(Term.and_elim1(Term.var("a")), Term.and_elim1(Term.var("b")));
        refine(2, Term.and_intro(soy1, soy2));
