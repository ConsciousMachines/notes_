...
(define (parse-expr sss)
  (match sss
    ...
    [`(∧-elim0 ,e1) (∧-elim0 (parse-expr e1))]
    [`(∧-elim1 ,e1) (∧-elim1 (parse-expr e1))]
    [`(∨-intro0 ,e1) (∨-intro0 (parse-expr e1))]
    [`(∨-intro1 ,e1) (∨-intro1 (parse-expr e1))]
...
(define (pretty-print-expr e)
  (match e
    [(∧-intro e1 e2) (format "(~a ∧ ~a)" (pretty-print-expr e1) (pretty-print-expr e2))]
    [(∧-elim0 e1) (format "(∧-elim0 ~a)" (pretty-print-expr e1))]
    [(∧-elim1 e1) (format "(∧-elim1 ~a)" (pretty-print-expr e1))]
    [(∨-intro0 e1) (format "(∨-intro0 ~a)" (pretty-print-expr e1))]
    [(∨-intro1 e1) (format "(∨-intro1 ~a)" (pretty-print-expr e1))]
...
(define (subst oldx newx expr)
  (match expr
    [(∧-intro e1 e2) (∧-intro (subst oldx newx e1) (subst oldx newx e2))]
    [(∧-elim0 e1) (∧-elim0 (subst oldx newx e1))]
    [(∧-elim1 e1) (∧-elim1 (subst oldx newx e1))]
    [(∨-intro0 e1) (∨-intro0 (subst oldx newx e1))]
    [(∨-intro1 e1) (∨-intro1 (subst oldx newx e1))]
    [(∨-elim e1 e2 e3) (∨-elim (subst oldx newx e1) (subst oldx newx e2) (subst oldx newx e3))]
...
(define (sc-helper x expr check-binders?)
  (match expr
    [(∧-intro e1 e2) (side-cond? x (list e1 e2) check-binders?)]
    [(∧-elim0 e1) (sc-helper x e1 check-binders?)]
    [(∧-elim1 e1) (sc-helper x e1 check-binders?)]
    [(∨-intro0 e1) (sc-helper x e1 check-binders?)]
    [(∨-intro1 e1) (sc-helper x e1 check-binders?)]
    [(∨-elim e1 e2 e3) (side-cond? x (list e1 e2 e3) check-binders?)]
...
(define (ae-helper e1 e2 vmap)
  (match (list e1 e2)
    [(list (∧-intro a1 a2) (∧-intro b1 b2))
       (and (ae-helper a1 b1 vmap) (ae-helper a2 b2 vmap))]
    [(list (∧-elim0 a1) (∧-elim0 b1))
       (ae-helper a1 b1 vmap)]
    [(list (∧-elim1 a1) (∧-elim1 b1))
       (ae-helper a1 b1 vmap)]
    [(list (∨-intro0 a1) (∨-intro0 b1))
       (ae-helper a1 b1 vmap)]
    [(list (∨-intro1 a1) (∨-intro1 b1))
       (ae-helper a1 b1 vmap)]
    [(list (∨-elim a1 a2 a3) (∨-elim b1 b2 b3))
       (and (ae-helper a1 b1 vmap) (ae-helper a2 b2 vmap) (ae-helper a3 b3 vmap))]
